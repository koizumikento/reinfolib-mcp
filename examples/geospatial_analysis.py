...
from reinfolib_mcp import ReinfiolibClient, ReinfiolibAPIError, ResponseFormat
...
class GeospatialAnalyzer:
    ...
    def _estimate_prefecture_code(self, lat: float, lon: float) -> Optional[str]:
        """座標から都道府県コードを推定（簡易実装）"""
        # 主要都市の座標範囲による簡易判定
